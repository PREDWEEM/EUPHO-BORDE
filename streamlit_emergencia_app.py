...
# Poné tu URL pública si querés el botón “Abrir app completa”
...
fecha_inicio = max(HOY, VENTANA_MIN)
fecha_fin    = min(HOY + pd.Timedelta(days=7), VENTANA_MAX)
...
def procesar_y_mostrar(df: pd.DataFrame, nombre: str):
    ...
    if df_win.empty:
        ...
        return
    # (Eliminado) No mostramos “solo X día(s) disponibles…”
