...
# Versión reducida: solo EMERREL_MA5 · eje Y=0.55 · área sombreada
...
# ------------------ SIDEBAR ------------------
st.sidebar.header("⚙️ Versión reducida sin EMEAC")
st.sidebar.caption("Solo EMERREL_MA5 — con área bajo la curva y eje Y=0.55")
...
class PracticalANNModel:
    ...
    def predict(self, X):
        ...
        y = self._tansig(z2)
        return self._denorm_output(y).clip(0, 1)
...
fig1.update_yaxes(range=[0, 0.70])
fig1.update_layout(
    xaxis_title="Fecha",
...
st.download_button(
    ...
    "resultados_predweem_MA5_bordenave.csv",
    "text/csv"
)
